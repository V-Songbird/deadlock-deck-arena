...
(function () {
  ...
  DD.Data.cosmetics = [
    {
      id: 'default',
      name: DD.t('Carne Cruda'),
      cost: 0,
      palette: ['#2b2130', '#6b5a7a', '#c9b8d8'],
      tint: '#9b8fb0',
      unlockedByDefault: true,
      desc: DD.t('La carne con la que llegaste. Nadie la eligió por ti.')
    },
    {
      id: 'embalmed',
      name: DD.t('Embalmado'),
      ...
      desc: DD.t('Formol, vendas apretadas y una sonrisa que ya no se mueve.')
    },
    {
      id: 'charred',
      name: DD.t('Carbonizado'),
      cost: 8,
      palette: ['#1a1210', '#4a3528', '#9c8873'],
      tint: '#e0562a',
      unlockedByDefault: false,
      desc: DD.t('Salió del incendio de la planta baja y siguió andando.')
    },
    {
      id: 'drowned',
      name: DD.t('Ahogado'),
      ...
      tint: '#4a9fd8',
      unlockedByDefault: false,
      desc: DD.t('Lo sacaron del depósito con los pulmones llenos de agua turbia.')
    },
    {
      id: 'fungal',
      name: DD.t('Fúngico'),
      ...
      tint: '#7fc23a',
      unlockedByDefault: false,
      desc: DD.t('Algo crece debajo de la piel y respira por los poros.')
    },
    {
      id: 'chromed',
      name: DD.t('Cromado'),
      ...
      tint: '#8fa2b8',
      unlockedByDefault: false,
      desc: DD.t('Cada músculo sustituido por una pieza que brilla demasiado.')
    },
    {
      id: 'gilded',
      name: DD.t('Dorado'),
      ...
      tint: '#e8b23a',
      unlockedByDefault: false,
      desc: DD.t('Los patronos pagan el oro. El cuerpo lo paga otro.')
    },
    {
      id: 'spectral',
      name: DD.t('Espectral'),
      ...
      tint: '#9fb8ff',
      unlockedByDefault: false,
      desc: DD.t('La mitad de ti ya está en la sala de al lado.')
    }
  ];
