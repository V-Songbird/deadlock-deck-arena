...
(function () {
  ...
  DD.Data.limbs = [
    ...
    /* --- osario --- */
    { id: 'ossuary_head', name: 'Cráneo Osario', slot: 'head', tier: 1,
      ...
      drops: false,
      flavor: 'Un cráneo limpio y hueco, más útil como herramienta que como cabeza.' },

    /* --- visceral --- */
    { id: 'visceral_head', name: 'Rostro Palpitante', slot: 'head', tier: 1,
      ...
      drops: true,
      flavor: 'Una cara prestada que supura y nunca deja de sonreír.' },

    /* --- mecánico --- */
    { id: 'mech_head', name: 'Cráneo de Válvulas', slot: 'head', tier: 1,
      ...
      drops: true,
      flavor: 'Latón, manómetros y un ojo de cristal que gira solo.' },

    /* --- espectral --- */
    { id: 'spectral_head', name: 'Cráneo Vidente', slot: 'head', tier: 2,
      ...
      drops: true,
      flavor: 'Mira hacia dentro y encuentra cosas que todavía no han ocurrido.' },

    /* --- alquímico --- */
    { id: 'alchemical_head', name: 'Córtex Alquímico', slot: 'head', tier: 2,
      ...
      drops: true,
      flavor: 'Un cerebro conservado en veneno: sólo piensa en dosis y antídotos.' },

    /* --- criogénico --- */
    { id: 'cryo_head', name: 'Mente Criogénica', slot: 'head', tier: 3,
      ...
      drops: true,
      flavor: 'Piensa despacio, congelando cada idea antes de llegar a usarla.' },

    /* ================= TORSOS (3 / 2 / 1) — HP and defense ================= */

    /* --- osario --- */
    { id: 'ossuary_torso', name: 'Caja Torácica', slot: 'torso', tier: 1,
      ...
      drops: false,
      flavor: 'Costillas secas que crujen con cada respiración y aguantan de milagro.' },

    /* --- visceral --- */
    { id: 'visceral_torso', name: 'Torso Palpitante', slot: 'torso', tier: 1,
      ...
      drops: true,
      flavor: 'Un tronco de músculo cosido a un corazón que no era suyo.' },

    /* --- mecánico --- */
    { id: 'mech_torso', name: 'Coraza de Caldera', slot: 'torso', tier: 1,
      ...
      drops: true,
      flavor: 'Cincuenta remaches y una caldera que nunca acaba de enfriarse.' },

    /* --- espectral --- */
    { id: 'spectral_torso', name: 'Torso Hueco', slot: 'torso', tier: 2,
      ...
      drops: true,
      flavor: 'No hay órganos: sólo un hueco que zumba y escupe chispas.' },

    /* --- alquímico --- */
    { id: 'alchemical_torso', name: 'Saco Venenoso', slot: 'torso', tier: 2,
      ...
      drops: true,
      flavor: 'Un buche traslúcido donde fermentan residuos y promesas.' },

    /* --- criogénico --- */
    { id: 'cryo_torso', name: 'Coraza Glacial', slot: 'torso', tier: 3,
      ...
      drops: true,
      flavor: 'Placas de hielo eterno; debajo, algo sigue latiendo muy despacio.' },

    /* ================= ARMS (4 / 3 / 1) — damage ================= */

    /* --- osario --- */
    { id: 'ossuary_arms', name: 'Garra Ósea', slot: 'arm', tier: 1,
      ...
      drops: false,
      flavor: 'Falanges afiladas que se parten al primer golpe mal dado.' },

    /* --- visceral --- */
    { id: 'visceral_arms', name: 'Brazo de Carne', slot: 'arm', tier: 1,
      ...
      drops: true,
      flavor: 'Músculo crudo cosido al hombro con hilo de tripa.' },

    /* --- mecánico --- */
    { id: 'mech_arms', name: 'Brazo de Pistón', slot: 'arm', tier: 1,
      ...
      drops: false,
      flavor: 'Lento, pesado, y capaz de abollar una puerta de hierro.' },

    /* --- espectral --- */
    { id: 'spectral_arms', name: 'Brazo Fantasmal', slot: 'arm', tier: 1,
      ...
      drops: false,
      flavor: 'Atraviesa la materia, pero el calor lo disuelve como niebla.' },

    /* --- alquímico --- */
    { id: 'alchemical_arms', name: 'Aguijón Venenoso', slot: 'arm', tier: 2,
      ...
      drops: true,
      flavor: 'Un aguijón hueco que se rellena solo mientras alguien sangre.' },

    /* --- mecánico, brutal --- */
    { id: 'brute_arm', name: 'Brazo de Garfio', slot: 'arm', tier: 2,
      ...
      drops: true,
      flavor: 'Un garfio de matadero con cadena, polea y muy malos modales.' },

    /* --- criogénico --- */
    { id: 'frost_arm', name: 'Lanza de Escarcha', slot: 'arm', tier: 2,
      ...
      drops: true,
      flavor: 'Un brazo convertido en carámbano; el primer golpe es siempre el más frío.' },

    /* --- osario --- */
    { id: 'reaver_arm', name: 'Brazo Segador', slot: 'arm', tier: 3,
      ...
      drops: true,
      flavor: 'Cosecha brazos ajenos para alargar el suyo: cada muñón lo hace más fuerte.' },

    /* ================= LEGS (3 / 2 / 1) — mobility, energy, cooling ================= */

    /* --- osario --- */
    { id: 'ossuary_legs', name: 'Zancos Óseos', slot: 'leg', tier: 1,
      ...
      drops: false,
      flavor: 'Dos fémures alargados con bisagras de alambre y mucha prisa.' },

    /* --- visceral --- */
    { id: 'visceral_legs', name: 'Piernas de Tendón', slot: 'leg', tier: 1,
      form: 'fleshy', palette: ['#3b1120', '#a52f3e', '#e5899a'],
      integrity: 24, heatCap: 90, coolRate: 5, maxHpBonus: 4,
      passive: { id: 'regen', v: 2 },
      cards: ['sprint', 'tendon_snap', 'blood_marathon'],
      drops: true,
      flavor: 'Tendones tensados como cuerdas de violín que se reajustan solos.' },

    /* --- mecánico --- */
    { id: 'mech_legs', name: 'Piernas de Muelle', slot: 'leg', tier: 1,
      ...
      drops: true,
      flavor: 'Muelles de coche y tubos de escape por donde resopla todo el cuerpo.' },

    /* --- espectral --- */
    { id: 'spectral_legs', name: 'Piernas Espectrales', slot: 'leg', tier: 2,
      ...
      drops: true,
      flavor: 'No tocan el suelo: flotan un dedo por encima del polvo.' },

    /* --- alquímico --- */
    { id: 'alchemical_legs', name: 'Piernas Ácidas', slot: 'leg', tier: 2,
      ...
      drops: true,
      flavor: 'Cada paso deja un charco que silba y disuelve la piedra.' },

    /* --- criogénico --- */
    { id: 'cryo_legs', name: 'Pisadas de Escarcha', slot: 'leg', tier: 3,
      ...
      drops: true,
      flavor: 'El suelo se hiela donde pisa; el tiempo también, un poco.' }
  ];
